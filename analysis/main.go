...
var workflowFiles = []WorkflowFile{
	{Path: "../test_workflows/1.yml", Name: "vwbench_workflow1"},
	{Path: "../test_workflows/2.yml", Name: "vwbench_workflow2"},
	{Path: "../test_workflows/3.yml", Name: "vwbench_workflow3"},
	{Path: "../test_workflows/4.yml", Name: "vwbench_workflow4"},
	{Path: "../test_workflows/5.yml", Name: "vwbench_workflow5"},
	// {Path: "../test_workflows/6.yml", Name: "vwbench_workflow6"},
	{Path: "../test_workflows/7.yml", Name: "vwbench_workflow7"},
	{Path: "../test_workflows/8.yml", Name: "vwbench_workflow8"},
	{Path: "../test_workflows/9.yml", Name: "vwbench_workflow9"},
	{Path: "../test_workflows/10.yml", Name: "vwbench_workflow10"},
	{Path: "../test_workflows/11.yml", Name: "vwbench_workflow11"},
	{Path: "../test_workflows/12.yml", Name: "vwbench_workflow12"},
	{Path: "../test_workflows/13.yml", Name: "vwbench_workflow13"},
	{Path: "../test_workflows/14.yml", Name: "vwbench_workflow14"},
	{Path: "../test_workflows/15.yml", Name: "vwbench_workflow15"},
	{Path: "../test_workflows/16.yml", Name: "vwbench_workflow16"},
	{Path: "../test_workflows/17.yml", Name: "vwbench_workflow17"},
	{Path: "../test_workflows/18.yml", Name: "vwbench_workflow18"},
	{Path: "../test_workflows/19.yml", Name: "vwbench_workflow19"},
	{Path: "../test_workflows/20.yml", Name: "vwbench_workflow20"},
	{Path: "../test_workflows/21.yml", Name: "vwbench_workflow21"},
	{Path: "../test_workflows/22.yml", Name: "vwbench_workflow22"},
	// {Path: "../test_workflows/23.yml", Name: "vwbench_workflow23"},
	// {Path: "../test_workflows/24.yml", Name: "vwbench_workflow24"},
}
